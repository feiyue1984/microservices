...
import microservices.book.multiplication.event.EventDispachter;
...
public class MultiplicationServiceImpl implements MultiplicationService {
    ...
    private EventDispachter eventDispachter;
    ...
    public MultiplicationServiceImpl(final RandomGeneratorService randomGeneratorService,
                                     ...
                                     final EventDispachter eventDispachter) {
        this.randomGeneratorService = randomGeneratorService;
        this.attemptRepository = attemptRepository;
        this.userRepository = userRepository;
        this.multiplicationRepository = multiplicationRepository;
        this.eventDispachter = eventDispachter;
    }
    ...
    public boolean checkAttempt(final MultiplicationResultAttempt attempt) {
        ...
        .findByFactorAAndFactorB(attempt.getMultiplication().getFactorA(), attempt.getMultiplication().getFactorB());
        ...
        eventDispachter.send(new MultiplicationSolvedEvent(checkedAttempt.getId(),
